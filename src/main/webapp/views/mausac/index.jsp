...
<div class="col-6 offset-3 mt-3">
    <a class="btn btn-success" href="/mau-sac/viewAdd">Add</a>
        ...
        <tbdoy>
            <c:forEach items="${list.content}" var="nv" >
                <tr>
                    ...
                    <td>${nv.ten}</td>
                    <td>
                        <a onclick="xacNhan(event)" href="/mau-sac/delete/${nv.id}" class="btn btn-danger">Xoa</a>
                        <a href="/mau-sac/viewUpdate/${nv.id}" class="btn btn-primary">Update</a>
                    </td>
                </tr>
            </c:forEach>
        </tbdoy>
