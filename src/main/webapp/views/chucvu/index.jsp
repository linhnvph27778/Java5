...
<div class="col-6 offset-3 mt-3">
    <a class="btn btn-success" href="/chuc-vu/viewAdd">Add</a>
...
<%--                    <td>${nv.id}</td>--%>
                    ...
                    <td>${nv.ten}</td>
                    <td>
                        <a onclick="xacNhan(event)" href="/chuc-vu/delete/${nv.id}" class="btn btn-danger">Xoa</a>
                        <a href="/chuc-vu/viewUpdate/${nv.id}" class="btn btn-primary">Update</a>
                    </td>
                </tr>
            </c:forEach>
        </tbdoy>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination">
            <c:forEach begin="0" end="${ list.totalPages -1}" varStatus="loop">
                <li class="page-item">
                    <a class="page-link" href="/chuc-vu/hien-thi?page=${loop.begin + loop.count - 1}">
