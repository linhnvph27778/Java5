...
<body>
    ...
    <div class="col-4 offset-4 mt-3">
       ...
       <sf:form method="post" action="/cua-hang/update" modelAttribute="cuaHang">
           <div class="mt-3">
           ...
           <div class="mt-3">
               ...
               <sf:errors element="span" path="thanhPho" cssClass="text-danger"/>
           </div>
           <div class="mt-3">
               <label class="">Quấc giá</label>
               <sf:input path="quacGia" cssClass="form-control"/>
               <sf:errors element="span" path="quacGia" cssClass="text-danger"/>
           </div>
           <div>
