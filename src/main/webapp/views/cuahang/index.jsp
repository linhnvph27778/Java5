...
<div class="col-10 offset-1 mt-3">
    <a class="btn btn-success" href="/cua-hang/viewAdd">Add</a>
...
<%--                    <td>${nv.id}</td>--%>
                    ...
                    <td>${nv.quacGia}</td>
                    <td>
                        <a onclick="xacNhan(event)" href="/cua-hang/delete/${nv.id}" class="btn btn-danger">Xoa</a>
                        <a href="/cua-hang/viewUpdate/${nv.id}" class="btn btn-primary">Update</a>
                    </td>
                </tr>
            </c:forEach>
        </tbdoy>
