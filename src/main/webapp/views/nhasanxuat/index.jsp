...
<div class="col-6 offset-3 mt-3">
    <a class="btn btn-success" href="/nha-san-xuat/viewAdd">Add</a>
...
<%--                    <td>${nv.id}</td>--%>
                    ...
                    <td>${nv.ten}</td>
                    <td>
                        <a onclick="xacNhan(event)" href="/nha-san-xuat/delete/${nv.id}" class="btn btn-danger">Xoa</a>
                        <a href="/nha-san-xuat/viewUpdate/${nv.id}" class="btn btn-primary">Update</a>
                    </td>
                </tr>
            </c:forEach>
        </tbdoy>
